...
func (ac *APICreate) check() error {
	...
	if _, ok := ac.mutation.Level(); !ok {
		return &ValidationError{Name: "level", err: errors.New(`ent: missing required field "API.level"`)}
	}
	if _, ok := ac.mutation.Hash(); !ok {
		return &ValidationError{Name: "hash", err: errors.New(`ent: missing required field "API.hash"`)}
	}
	if _, ok := ac.mutation.Component(); !ok {
		return &ValidationError{Name: "component", err: errors.New(`ent: missing required field "API.component"`)}
	}
	if _, ok := ac.mutation.IsSub(); !ok {
		return &ValidationError{Name: "isSub", err: errors.New(`ent: missing required field "API.isSub"`)}
	}
	if _, ok := ac.mutation.HasSub(); !ok {
		return &ValidationError{Name: "hasSub", err: errors.New(`ent: missing required field "API.hasSub"`)}
	}
	if _, ok := ac.mutation.Single(); !ok {
		return &ValidationError{Name: "single", err: errors.New(`ent: missing required field "API.single"`)}
	}
	if _, ok := ac.mutation.ParentId(); !ok {
		return &ValidationError{Name: "parentId", err: errors.New(`ent: missing required field "API.parentId"`)}
	}
	if _, ok := ac.mutation.TenantId(); !ok {
		return &ValidationError{Name: "tenantId", err: errors.New(`ent: missing required field "API.tenantId"`)}
	}
	...
	if _, ok := ac.mutation.Deleted(); !ok {
		return &ValidationError{Name: "deleted", err: errors.New(`ent: missing required field "API.deleted"`)}
	}
	return nil
}

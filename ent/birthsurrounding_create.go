...
func (bsc *BirthSurroundingCreate) Save(ctx context.Context) (*BirthSurrounding, error) {
	...
	if len(bsc.hooks) == 0 {
		...
		nv, ok := v.(*BirthSurrounding)
		if !ok {
			return nil, fmt.Errorf("unexpected node type %T returned from BirthSurroundingMutation", v)
		}
		node = nv
	}
	return node, err
...
func (bsc *BirthSurroundingCreate) Exec(ctx context.Context) error {
	_, err := bsc.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (bsc *BirthSurroundingCreate) ExecX(ctx context.Context) {
...
func (bsc *BirthSurroundingCreate) check() error {
	if _, ok := bsc.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "BirthSurrounding.name"`)}
	}
	if _, ok := bsc.mutation.FarmId(); !ok {
		return &ValidationError{Name: "farmId", err: errors.New(`ent: missing required field "BirthSurrounding.farmId"`)}
	}
	if _, ok := bsc.mutation.FarmName(); !ok {
		return &ValidationError{Name: "farmName", err: errors.New(`ent: missing required field "BirthSurrounding.farmName"`)}
	}
	if v, ok := bsc.mutation.FarmName(); ok {
		if err := birthsurrounding.FarmNameValidator(v); err != nil {
			return &ValidationError{Name: "farmName", err: fmt.Errorf(`ent: validator failed for field "BirthSurrounding.farmName": %w`, err)}
		}
	}
	if _, ok := bsc.mutation.RecordTime(); !ok {
		return &ValidationError{Name: "recordTime", err: errors.New(`ent: missing required field "BirthSurrounding.recordTime"`)}
	}
	if _, ok := bsc.mutation.UserId(); !ok {
		return &ValidationError{Name: "userId", err: errors.New(`ent: missing required field "BirthSurrounding.userId"`)}
	}
	if _, ok := bsc.mutation.UserName(); !ok {
		return &ValidationError{Name: "userName", err: errors.New(`ent: missing required field "BirthSurrounding.userName"`)}
	}
	if _, ok := bsc.mutation.Temperature(); !ok {
		return &ValidationError{Name: "temperature", err: errors.New(`ent: missing required field "BirthSurrounding.temperature"`)}
	}
	if _, ok := bsc.mutation.Humidity(); !ok {
		return &ValidationError{Name: "humidity", err: errors.New(`ent: missing required field "BirthSurrounding.humidity"`)}
	}
	if _, ok := bsc.mutation.BreathRateId(); !ok {
		return &ValidationError{Name: "breathRateId", err: errors.New(`ent: missing required field "BirthSurrounding.breathRateId"`)}
	}
	if _, ok := bsc.mutation.BreathRateName(); !ok {
		return &ValidationError{Name: "breathRateName", err: errors.New(`ent: missing required field "BirthSurrounding.breathRateName"`)}
	}
	if _, ok := bsc.mutation.WindSpeed(); !ok {
		return &ValidationError{Name: "windSpeed", err: errors.New(`ent: missing required field "BirthSurrounding.windSpeed"`)}
	}
	if _, ok := bsc.mutation.WindDirectionId(); !ok {
		return &ValidationError{Name: "windDirectionId", err: errors.New(`ent: missing required field "BirthSurrounding.windDirectionId"`)}
	}
	if _, ok := bsc.mutation.WindDirection(); !ok {
		return &ValidationError{Name: "windDirection", err: errors.New(`ent: missing required field "BirthSurrounding.windDirection"`)}
	}
	if _, ok := bsc.mutation.LocationChanges(); !ok {
		return &ValidationError{Name: "locationChanges", err: errors.New(`ent: missing required field "BirthSurrounding.locationChanges"`)}
	}
	if _, ok := bsc.mutation.HairStateId(); !ok {
		return &ValidationError{Name: "hairStateId", err: errors.New(`ent: missing required field "BirthSurrounding.hairStateId"`)}
	}
	if _, ok := bsc.mutation.HairStateName(); !ok {
		return &ValidationError{Name: "hairStateName", err: errors.New(`ent: missing required field "BirthSurrounding.hairStateName"`)}
	}
	if _, ok := bsc.mutation.SoilDepth(); !ok {
		return &ValidationError{Name: "soilDepth", err: errors.New(`ent: missing required field "BirthSurrounding.soilDepth"`)}
	}
	if _, ok := bsc.mutation.SunExposure(); !ok {
		return &ValidationError{Name: "sunExposure", err: errors.New(`ent: missing required field "BirthSurrounding.sunExposure"`)}
	}
	if _, ok := bsc.mutation.WalkDistance(); !ok {
		return &ValidationError{Name: "walkDistance", err: errors.New(`ent: missing required field "BirthSurrounding.walkDistance"`)}
	}
	if _, ok := bsc.mutation.Rained(); !ok {
		return &ValidationError{Name: "rained", err: errors.New(`ent: missing required field "BirthSurrounding.rained"`)}
	}
	if _, ok := bsc.mutation.ThIndex(); !ok {
		return &ValidationError{Name: "thIndex", err: errors.New(`ent: missing required field "BirthSurrounding.thIndex"`)}
	}
	if _, ok := bsc.mutation.TenantId(); !ok {
		return &ValidationError{Name: "tenantId", err: errors.New(`ent: missing required field "BirthSurrounding.tenantId"`)}
	}
	if _, ok := bsc.mutation.TenantName(); !ok {
		return &ValidationError{Name: "tenantName", err: errors.New(`ent: missing required field "BirthSurrounding.tenantName"`)}
	}
	if _, ok := bsc.mutation.Remarks(); !ok {
		return &ValidationError{Name: "remarks", err: errors.New(`ent: missing required field "BirthSurrounding.remarks"`)}
	}
	if _, ok := bsc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`ent: missing required field "BirthSurrounding.createdAt"`)}
	}
	if _, ok := bsc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`ent: missing required field "BirthSurrounding.updatedAt"`)}
	}
	if _, ok := bsc.mutation.Deleted(); !ok {
		return &ValidationError{Name: "deleted", err: errors.New(`ent: missing required field "BirthSurrounding.deleted"`)}
	}
	return nil
}
...
// BirthSurroundingCreateBulk is the builder for creating many BirthSurrounding entities in bulk.
...
// Exec executes the query.
func (bscb *BirthSurroundingCreateBulk) Exec(ctx context.Context) error {
	_, err := bscb.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (bscb *BirthSurroundingCreateBulk) ExecX(ctx context.Context) {

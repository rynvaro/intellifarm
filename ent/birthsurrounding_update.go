...
// Where appends a list predicates to the BirthSurroundingUpdate builder.
...
// AddRecordTime adds i to the "recordTime" field.
...
// AddTemperature adds i to the "temperature" field.
...
// AddHumidity adds i to the "humidity" field.
...
// AddBreathRateId adds i to the "breathRateId" field.
...
// AddWindSpeed adds i to the "windSpeed" field.
...
// AddWindDirectionId adds i to the "windDirectionId" field.
...
// AddLocationChanges adds i to the "locationChanges" field.
...
// AddHairStateId adds i to the "hairStateId" field.
...
// AddSoilDepth adds i to the "soilDepth" field.
...
// AddSunExposure adds i to the "sunExposure" field.
...
// AddWalkDistance adds i to the "walkDistance" field.
...
// AddRained adds i to the "rained" field.
...
// AddThIndex adds f to the "thIndex" field.
...
func (bsuo *BirthSurroundingUpdateOne) Select(field string, fields ...string) *BirthSurroundingUpdateOne {
	bsuo.fields = append([]string{field}, fields...)
	return bsuo
}

// Save executes the query and returns the updated BirthSurrounding entity.
func (bsuo *BirthSurroundingUpdateOne) Save(ctx context.Context) (*BirthSurrounding, error) {
	...
	if len(bsuo.hooks) == 0 {
		...
		v, err := mut.Mutate(ctx, bsuo.mutation)
		if err != nil {
			return nil, err
		}
...
func (bsuo *BirthSurroundingUpdateOne) sqlSave(ctx context.Context) (_node *BirthSurrounding, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "BirthSurrounding.id" for update`)}
	}

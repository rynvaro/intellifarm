...
// Where appends a list predicates to the BreedingUpdate builder.
...
// AddSemenFrozenTypeId adds i to the "semenFrozenTypeId" field.
...
func (buo *BreedingUpdateOne) Select(field string, fields ...string) *BreedingUpdateOne {
	buo.fields = append([]string{field}, fields...)
	return buo
}

// Save executes the query and returns the updated Breeding entity.
...
func (buo *BreedingUpdateOne) sqlSave(ctx context.Context) (_node *Breeding, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "Breeding.id" for update`)}
	}

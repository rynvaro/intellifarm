...
func (cc *CalveCreate) check() error {
	...
	if _, ok := cc.mutation.CalveAt(); !ok {
		return &ValidationError{Name: "calveAt", err: errors.New("ent: missing required field \"calveAt\"")}
	}
	if _, ok := cc.mutation.CalveTypeId(); !ok {
		return &ValidationError{Name: "calveTypeId", err: errors.New("ent: missing required field \"calveTypeId\"")}
	}
	if _, ok := cc.mutation.CalveTypeName(); !ok {
		return &ValidationError{Name: "calveTypeName", err: errors.New("ent: missing required field \"calveTypeName\"")}
	}
	if _, ok := cc.mutation.CalveCate(); !ok {
		return &ValidationError{Name: "calveCate", err: errors.New("ent: missing required field \"calveCate\"")}
	}
	if _, ok := cc.mutation.CalveCountId(); !ok {
		return &ValidationError{Name: "calveCountId", err: errors.New("ent: missing required field \"calveCountId\"")}
	}
	if _, ok := cc.mutation.CalveCountName(); !ok {
		return &ValidationError{Name: "calveCountName", err: errors.New("ent: missing required field \"calveCountName\"")}
	}
	...
	if _, ok := cc.mutation.BabyStatus(); !ok {
		return &ValidationError{Name: "babyStatus", err: errors.New("ent: missing required field \"babyStatus\"")}
	}
	if _, ok := cc.mutation.BabyGender(); !ok {
		return &ValidationError{Name: "babyGender", err: errors.New("ent: missing required field \"babyGender\"")}
	}
	if _, ok := cc.mutation.BabyEarNumber(); !ok {
		return &ValidationError{Name: "babyEarNumber", err: errors.New("ent: missing required field \"babyEarNumber\"")}
	}
	if _, ok := cc.mutation.BabyBreedId(); !ok {
		return &ValidationError{Name: "babyBreedId", err: errors.New("ent: missing required field \"babyBreedId\"")}
	}
	if _, ok := cc.mutation.BabyBreedName(); !ok {
		return &ValidationError{Name: "babyBreedName", err: errors.New("ent: missing required field \"babyBreedName\"")}
	}
	if _, ok := cc.mutation.BabyHairColorId(); !ok {
		return &ValidationError{Name: "babyHairColorId", err: errors.New("ent: missing required field \"babyHairColorId\"")}
	}
	if _, ok := cc.mutation.BabyHairColorName(); !ok {
		return &ValidationError{Name: "babyHairColorName", err: errors.New("ent: missing required field \"babyHairColorName\"")}
	}
	if _, ok := cc.mutation.BabyWeight(); !ok {
		return &ValidationError{Name: "babyWeight", err: errors.New("ent: missing required field \"babyWeight\"")}
	}
	if _, ok := cc.mutation.BabyShedId(); !ok {
		return &ValidationError{Name: "babyShedId", err: errors.New("ent: missing required field \"babyShedId\"")}
	}
...
// CalveCreateBulk is the builder for creating a bulk of Calve entities.

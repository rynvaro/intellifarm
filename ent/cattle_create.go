...
func (cc *CattleCreate) check() error {
	...
	if _, ok := cc.mutation.ElectronicEarNumber(); !ok {
		return &ValidationError{Name: "electronicEarNumber", err: errors.New("ent: missing required field \"electronicEarNumber\"")}
	}
	if _, ok := cc.mutation.Pedometer(); !ok {
		return &ValidationError{Name: "pedometer", err: errors.New("ent: missing required field \"pedometer\"")}
	}
	if _, ok := cc.mutation.GenderId(); !ok {
		return &ValidationError{Name: "genderId", err: errors.New("ent: missing required field \"genderId\"")}
	}
	if _, ok := cc.mutation.GenderName(); !ok {
		return &ValidationError{Name: "genderName", err: errors.New("ent: missing required field \"genderName\"")}
	}
	...
	if _, ok := cc.mutation.CateId(); !ok {
		return &ValidationError{Name: "cateId", err: errors.New("ent: missing required field \"cateId\"")}
	}
	if _, ok := cc.mutation.CateName(); !ok {
		return &ValidationError{Name: "cateName", err: errors.New("ent: missing required field \"cateName\"")}
	}
	...
	if _, ok := cc.mutation.Breed(); !ok {
		return &ValidationError{Name: "breed", err: errors.New("ent: missing required field \"breed\"")}
	}
	if _, ok := cc.mutation.JoinedTypeId(); !ok {
		return &ValidationError{Name: "joinedTypeId", err: errors.New("ent: missing required field \"joinedTypeId\"")}
	}
	if _, ok := cc.mutation.JoinedTypeName(); !ok {
		return &ValidationError{Name: "joinedTypeName", err: errors.New("ent: missing required field \"joinedTypeName\"")}
	}
	if _, ok := cc.mutation.Mother(); !ok {
		return &ValidationError{Name: "mother", err: errors.New("ent: missing required field \"mother\"")}
	}
	if _, ok := cc.mutation.Father(); !ok {
		return &ValidationError{Name: "father", err: errors.New("ent: missing required field \"father\"")}
	}
	if _, ok := cc.mutation.Grandfather(); !ok {
		return &ValidationError{Name: "grandfather", err: errors.New("ent: missing required field \"grandfather\"")}
	}
	...
	if _, ok := cc.mutation.OwnerName(); !ok {
		return &ValidationError{Name: "ownerName", err: errors.New("ent: missing required field \"ownerName\"")}
	}
	if _, ok := cc.mutation.HairColorId(); !ok {
		return &ValidationError{Name: "hairColorId", err: errors.New("ent: missing required field \"hairColorId\"")}
	}
	...
	if _, ok := cc.mutation.LastCalvingAt(); !ok {
		return &ValidationError{Name: "lastCalvingAt", err: errors.New("ent: missing required field \"lastCalvingAt\"")}
	}
...
// CattleCreateBulk is the builder for creating a bulk of Cattle entities.

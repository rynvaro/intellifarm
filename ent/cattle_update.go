...
// Where appends a list predicates to the CattleUpdate builder.
...
// AddAlive adds i to the "alive" field.
...
// AddReproductiveStateId adds i to the "reproductiveStateId" field.
...
// AddGenderId adds i to the "genderId" field.
...
// AddCateId adds i to the "cateId" field.
...
// AddJoinedTypeId adds i to the "joinedTypeId" field.
...
// AddHairColorId adds i to the "hairColorId" field.
...
// AddPregnantTimes adds i to the "pregnantTimes" field.
...
// AddLastCalvingAt adds i to the "lastCalvingAt" field.
...
// AddBreedingAt adds i to the "breedingAt" field.
...
// AddBreedingTypeId adds i to the "breedingTypeId" field.
...
// AddBullId adds i to the "bullId" field.
...
// AddPregnancyCheckAt adds i to the "pregnancyCheckAt" field.
...
func (cuo *CattleUpdateOne) Select(field string, fields ...string) *CattleUpdateOne {
	cuo.fields = append([]string{field}, fields...)
	return cuo
}

// Save executes the query and returns the updated Cattle entity.
...
func (cuo *CattleUpdateOne) sqlSave(ctx context.Context) (_node *Cattle, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "Cattle.id" for update`)}
	}

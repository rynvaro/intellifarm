...
// Where appends a list predicates to the CattleBreedUpdate builder.
...
func (cbuo *CattleBreedUpdateOne) Select(field string, fields ...string) *CattleBreedUpdateOne {
	cbuo.fields = append([]string{field}, fields...)
	return cbuo
}

// Save executes the query and returns the updated CattleBreed entity.
...
func (cbuo *CattleBreedUpdateOne) sqlSave(ctx context.Context) (_node *CattleBreed, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "CattleBreed.id" for update`)}
	}

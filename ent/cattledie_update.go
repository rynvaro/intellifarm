...
// Where appends a list predicates to the CattleDieUpdate builder.
...
// AddInsured adds i to the "insured" field.
...
// AddDeclared adds i to the "declared" field.
...
func (cduo *CattleDieUpdateOne) Select(field string, fields ...string) *CattleDieUpdateOne {
	cduo.fields = append([]string{field}, fields...)
	return cduo
}

// Save executes the query and returns the updated CattleDie entity.
...
func (cduo *CattleDieUpdateOne) sqlSave(ctx context.Context) (_node *CattleDie, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "CattleDie.id" for update`)}
	}

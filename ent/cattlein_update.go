...
// Where appends a list predicates to the CattleInUpdate builder.
...
// AddJoinType adds i to the "joinType" field.
...
func (ciuo *CattleInUpdateOne) Select(field string, fields ...string) *CattleInUpdateOne {
	ciuo.fields = append([]string{field}, fields...)
	return ciuo
}

// Save executes the query and returns the updated CattleIn entity.
...
func (ciuo *CattleInUpdateOne) sqlSave(ctx context.Context) (_node *CattleIn, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "CattleIn.id" for update`)}
	}

...
func ID(id int) predicate.ConcentrateProcess {
...
func IDEQ(id int) predicate.ConcentrateProcess {
	return predicate.ConcentrateProcess(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.ConcentrateProcess {
	return predicate.ConcentrateProcess(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.ConcentrateProcess {
	return predicate.ConcentrateProcess(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.ConcentrateProcess {
	return predicate.ConcentrateProcess(func(s *sql.Selector) {
		v := make([]interface{}, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id int) predicate.ConcentrateProcess {
	return predicate.ConcentrateProcess(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.ConcentrateProcess {
	return predicate.ConcentrateProcess(func(s *sql.Selector) {
...
func IDLT(id int) predicate.ConcentrateProcess {
	return predicate.ConcentrateProcess(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.ConcentrateProcess {
	return predicate.ConcentrateProcess(func(s *sql.Selector) {

...
func (cq *ConfQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (cq *ConfQuery) FirstIDX(ctx context.Context) int {
...
func (cq *ConfQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (cq *ConfQuery) OnlyIDX(ctx context.Context) int {
...
func (cq *ConfQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
...
func (cq *ConfQuery) IDsX(ctx context.Context) []int {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}

...
// Where appends a list predicates to the EpidemicUpdate builder.
...
// AddOnset adds i to the "onset" field.
...
// AddEpidemicTypeId adds i to the "epidemicTypeId" field.
...
// AddTreatmentResultId adds i to the "treatmentResultId" field.
...
// AddTreatmentAt adds i to the "treatmentAt" field.
...
func (euo *EpidemicUpdateOne) Select(field string, fields ...string) *EpidemicUpdateOne {
	euo.fields = append([]string{field}, fields...)
	return euo
}

// Save executes the query and returns the updated Epidemic entity.
...
func (euo *EpidemicUpdateOne) sqlSave(ctx context.Context) (_node *Epidemic, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "Epidemic.id" for update`)}
	}

...
func (fc *FarmCreate) Exec(ctx context.Context) error {
	_, err := fc.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (fc *FarmCreate) ExecX(ctx context.Context) {
...
func (fc *FarmCreate) check() error {
	...
	if _, ok := fc.mutation.Code(); !ok {
		return &ValidationError{Name: "code", err: errors.New(`ent: missing required field "Farm.code"`)}
	}
	...
	if _, ok := fc.mutation.ConstructionDate(); !ok {
		return &ValidationError{Name: "constructionDate", err: errors.New(`ent: missing required field "Farm.constructionDate"`)}
	}
	if _, ok := fc.mutation.FeedingScale(); !ok {
		return &ValidationError{Name: "feedingScale", err: errors.New(`ent: missing required field "Farm.feedingScale"`)}
	}
	if _, ok := fc.mutation.ContactUser(); !ok {
		return &ValidationError{Name: "contactUser", err: errors.New(`ent: missing required field "Farm.contactUser"`)}
	}
	if _, ok := fc.mutation.ContactPhone(); !ok {
		return &ValidationError{Name: "contactPhone", err: errors.New(`ent: missing required field "Farm.contactPhone"`)}
	}
	if _, ok := fc.mutation.ContactAddress(); !ok {
		return &ValidationError{Name: "contactAddress", err: errors.New(`ent: missing required field "Farm.contactAddress"`)}
	}
	if _, ok := fc.mutation.Square(); !ok {
		return &ValidationError{Name: "square", err: errors.New(`ent: missing required field "Farm.square"`)}
	}
	if _, ok := fc.mutation.ShedCount(); !ok {
		return &ValidationError{Name: "shedCount", err: errors.New(`ent: missing required field "Farm.shedCount"`)}
	}
	if _, ok := fc.mutation.CategoryId(); !ok {
		return &ValidationError{Name: "categoryId", err: errors.New(`ent: missing required field "Farm.categoryId"`)}
	}
	if _, ok := fc.mutation.CategoryName(); !ok {
		return &ValidationError{Name: "categoryName", err: errors.New(`ent: missing required field "Farm.categoryName"`)}
	}
	if _, ok := fc.mutation.VarietyId(); !ok {
		return &ValidationError{Name: "varietyId", err: errors.New(`ent: missing required field "Farm.varietyId"`)}
	}
	if _, ok := fc.mutation.VarietyName(); !ok {
		return &ValidationError{Name: "varietyName", err: errors.New(`ent: missing required field "Farm.varietyName"`)}
	}
	if _, ok := fc.mutation.DistrictCode(); !ok {
		return &ValidationError{Name: "districtCode", err: errors.New(`ent: missing required field "Farm.districtCode"`)}
	}
	if _, ok := fc.mutation.DistrictName(); !ok {
		return &ValidationError{Name: "districtName", err: errors.New(`ent: missing required field "Farm.districtName"`)}
	}
	if _, ok := fc.mutation.TenantId(); !ok {
		return &ValidationError{Name: "tenantId", err: errors.New(`ent: missing required field "Farm.tenantId"`)}
	}
	if _, ok := fc.mutation.TenantName(); !ok {
		return &ValidationError{Name: "tenantName", err: errors.New(`ent: missing required field "Farm.tenantName"`)}
	}
	if _, ok := fc.mutation.Remarks(); !ok {
		return &ValidationError{Name: "remarks", err: errors.New(`ent: missing required field "Farm.remarks"`)}
	}
	if _, ok := fc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`ent: missing required field "Farm.createdAt"`)}
	}
	if _, ok := fc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`ent: missing required field "Farm.updatedAt"`)}
	}
	if _, ok := fc.mutation.Deleted(); !ok {
		return &ValidationError{Name: "deleted", err: errors.New(`ent: missing required field "Farm.deleted"`)}
	}
	return nil
}
...
// Exec executes the query.
func (fcb *FarmCreateBulk) Exec(ctx context.Context) error {
	_, err := fcb.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (fcb *FarmCreateBulk) ExecX(ctx context.Context) {

...
func (fic *FeedInfoCreate) Save(ctx context.Context) (*FeedInfo, error) {
	...
	if len(fic.hooks) == 0 {
		...
		v, err := mut.Mutate(ctx, fic.mutation)
		if err != nil {
			return nil, err
		}
		nv, ok := v.(*FeedInfo)
		if !ok {
			return nil, fmt.Errorf("unexpected node type %T returned from FeedInfoMutation", v)
		}
		node = nv
	}
	return node, err
...
func (fic *FeedInfoCreate) Exec(ctx context.Context) error {
	_, err := fic.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (fic *FeedInfoCreate) ExecX(ctx context.Context) {
...
func (fic *FeedInfoCreate) check() error {
	if _, ok := fic.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "FeedInfo.name"`)}
	}
	if _, ok := fic.mutation.Code(); !ok {
		return &ValidationError{Name: "code", err: errors.New(`ent: missing required field "FeedInfo.code"`)}
	}
	if _, ok := fic.mutation.Moisture(); !ok {
		return &ValidationError{Name: "moisture", err: errors.New(`ent: missing required field "FeedInfo.moisture"`)}
	}
	if _, ok := fic.mutation.DryMatter(); !ok {
		return &ValidationError{Name: "dryMatter", err: errors.New(`ent: missing required field "FeedInfo.dryMatter"`)}
	}
	if _, ok := fic.mutation.Ndf(); !ok {
		return &ValidationError{Name: "ndf", err: errors.New(`ent: missing required field "FeedInfo.ndf"`)}
	}
	if _, ok := fic.mutation.Adf(); !ok {
		return &ValidationError{Name: "adf", err: errors.New(`ent: missing required field "FeedInfo.adf"`)}
	}
	if _, ok := fic.mutation.Endf(); !ok {
		return &ValidationError{Name: "endf", err: errors.New(`ent: missing required field "FeedInfo.endf"`)}
	}
	if _, ok := fic.mutation.LacticAcid(); !ok {
		return &ValidationError{Name: "lacticAcid", err: errors.New(`ent: missing required field "FeedInfo.lacticAcid"`)}
	}
	if _, ok := fic.mutation.Wsc(); !ok {
		return &ValidationError{Name: "wsc", err: errors.New(`ent: missing required field "FeedInfo.wsc"`)}
	}
	if _, ok := fic.mutation.Starch(); !ok {
		return &ValidationError{Name: "starch", err: errors.New(`ent: missing required field "FeedInfo.starch"`)}
	}
	if _, ok := fic.mutation.SolubleFiber(); !ok {
		return &ValidationError{Name: "solubleFiber", err: errors.New(`ent: missing required field "FeedInfo.solubleFiber"`)}
	}
	if _, ok := fic.mutation.TotalProtein(); !ok {
		return &ValidationError{Name: "totalProtein", err: errors.New(`ent: missing required field "FeedInfo.totalProtein"`)}
	}
	if _, ok := fic.mutation.SolubleProtein(); !ok {
		return &ValidationError{Name: "solubleProtein", err: errors.New(`ent: missing required field "FeedInfo.solubleProtein"`)}
	}
	if _, ok := fic.mutation.Rdp(); !ok {
		return &ValidationError{Name: "rdp", err: errors.New(`ent: missing required field "FeedInfo.rdp"`)}
	}
	if _, ok := fic.mutation.Me(); !ok {
		return &ValidationError{Name: "me", err: errors.New(`ent: missing required field "FeedInfo.me"`)}
	}
	if _, ok := fic.mutation.Nel(); !ok {
		return &ValidationError{Name: "nel", err: errors.New(`ent: missing required field "FeedInfo.nel"`)}
	}
	if _, ok := fic.mutation.CrudeFat(); !ok {
		return &ValidationError{Name: "crudeFat", err: errors.New(`ent: missing required field "FeedInfo.crudeFat"`)}
	}
	if _, ok := fic.mutation.TotalFttyAcid(); !ok {
		return &ValidationError{Name: "totalFttyAcid", err: errors.New(`ent: missing required field "FeedInfo.totalFttyAcid"`)}
	}
	if _, ok := fic.mutation.Ash(); !ok {
		return &ValidationError{Name: "ash", err: errors.New(`ent: missing required field "FeedInfo.ash"`)}
	}
	if _, ok := fic.mutation.Ca(); !ok {
		return &ValidationError{Name: "ca", err: errors.New(`ent: missing required field "FeedInfo.ca"`)}
	}
	if _, ok := fic.mutation.P(); !ok {
		return &ValidationError{Name: "p", err: errors.New(`ent: missing required field "FeedInfo.p"`)}
	}
	if _, ok := fic.mutation.Mg(); !ok {
		return &ValidationError{Name: "mg", err: errors.New(`ent: missing required field "FeedInfo.mg"`)}
	}
	if _, ok := fic.mutation.K(); !ok {
		return &ValidationError{Name: "k", err: errors.New(`ent: missing required field "FeedInfo.k"`)}
	}
	if _, ok := fic.mutation.Mn(); !ok {
		return &ValidationError{Name: "mn", err: errors.New(`ent: missing required field "FeedInfo.mn"`)}
	}
	if _, ok := fic.mutation.Cu(); !ok {
		return &ValidationError{Name: "cu", err: errors.New(`ent: missing required field "FeedInfo.cu"`)}
	}
	if _, ok := fic.mutation.Fe(); !ok {
		return &ValidationError{Name: "fe", err: errors.New(`ent: missing required field "FeedInfo.fe"`)}
	}
	if _, ok := fic.mutation.Zn(); !ok {
		return &ValidationError{Name: "zn", err: errors.New(`ent: missing required field "FeedInfo.zn"`)}
	}
	if _, ok := fic.mutation.Methionine(); !ok {
		return &ValidationError{Name: "methionine", err: errors.New(`ent: missing required field "FeedInfo.methionine"`)}
	}
	if _, ok := fic.mutation.Lysine(); !ok {
		return &ValidationError{Name: "lysine", err: errors.New(`ent: missing required field "FeedInfo.lysine"`)}
	}
	if _, ok := fic.mutation.VitaminA(); !ok {
		return &ValidationError{Name: "vitaminA", err: errors.New(`ent: missing required field "FeedInfo.vitaminA"`)}
	}
	if _, ok := fic.mutation.VitaminD3(); !ok {
		return &ValidationError{Name: "vitaminD3", err: errors.New(`ent: missing required field "FeedInfo.vitaminD3"`)}
	}
	if _, ok := fic.mutation.VitaminE(); !ok {
		return &ValidationError{Name: "vitaminE", err: errors.New(`ent: missing required field "FeedInfo.vitaminE"`)}
	}
	if _, ok := fic.mutation.Choline(); !ok {
		return &ValidationError{Name: "choline", err: errors.New(`ent: missing required field "FeedInfo.choline"`)}
	}
	if _, ok := fic.mutation.Biotin(); !ok {
		return &ValidationError{Name: "biotin", err: errors.New(`ent: missing required field "FeedInfo.biotin"`)}
	}
	return nil
}
...
// FeedInfoCreateBulk is the builder for creating many FeedInfo entities in bulk.
...
// Exec executes the query.
func (ficb *FeedInfoCreateBulk) Exec(ctx context.Context) error {
	_, err := ficb.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (ficb *FeedInfoCreateBulk) ExecX(ctx context.Context) {

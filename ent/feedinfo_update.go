...
// Where appends a list predicates to the FeedInfoUpdate builder.
...
// AddMoisture adds f to the "moisture" field.
...
// AddDryMatter adds f to the "dryMatter" field.
...
// AddNdf adds f to the "ndf" field.
...
// AddAdf adds f to the "adf" field.
...
// AddEndf adds f to the "endf" field.
...
// AddLacticAcid adds f to the "lacticAcid" field.
...
// AddWsc adds f to the "wsc" field.
...
// AddStarch adds f to the "starch" field.
...
// AddSolubleFiber adds f to the "solubleFiber" field.
...
// AddTotalProtein adds f to the "totalProtein" field.
...
// AddSolubleProtein adds f to the "solubleProtein" field.
...
// AddRdp adds f to the "rdp" field.
...
// AddNel adds f to the "nel" field.
...
// AddCrudeFat adds f to the "crudeFat" field.
...
// AddTotalFttyAcid adds f to the "totalFttyAcid" field.
...
// AddAsh adds f to the "ash" field.
...
// AddMethionine adds f to the "methionine" field.
...
// AddLysine adds f to the "lysine" field.
...
// AddVitaminA adds f to the "vitaminA" field.
...
// AddVitaminD3 adds f to the "vitaminD3" field.
...
// AddVitaminE adds f to the "vitaminE" field.
...
// AddCholine adds f to the "choline" field.
...
// AddBiotin adds f to the "biotin" field.
...
func (fiuo *FeedInfoUpdateOne) Select(field string, fields ...string) *FeedInfoUpdateOne {
	fiuo.fields = append([]string{field}, fields...)
	return fiuo
}

// Save executes the query and returns the updated FeedInfo entity.
func (fiuo *FeedInfoUpdateOne) Save(ctx context.Context) (*FeedInfo, error) {
	...
	if len(fiuo.hooks) == 0 {
		...
		v, err := mut.Mutate(ctx, fiuo.mutation)
		if err != nil {
			return nil, err
		}
		nv, ok := v.(*FeedInfo)
...
func (fiuo *FeedInfoUpdateOne) sqlSave(ctx context.Context) (_node *FeedInfo, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "FeedInfo.id" for update`)}
	}

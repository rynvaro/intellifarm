...
func (hcc *HealthCareCreate) Exec(ctx context.Context) error {
	_, err := hcc.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (hcc *HealthCareCreate) ExecX(ctx context.Context) {
...
func (hcc *HealthCareCreate) check() error {
	if _, ok := hcc.mutation.CattleId(); !ok {
		return &ValidationError{Name: "cattleId", err: errors.New(`ent: missing required field "HealthCare.cattleId"`)}
	}
	if _, ok := hcc.mutation.TenantId(); !ok {
		return &ValidationError{Name: "tenantId", err: errors.New(`ent: missing required field "HealthCare.tenantId"`)}
	}
	if _, ok := hcc.mutation.TenantName(); !ok {
		return &ValidationError{Name: "tenantName", err: errors.New(`ent: missing required field "HealthCare.tenantName"`)}
	}
	if _, ok := hcc.mutation.FarmId(); !ok {
		return &ValidationError{Name: "farmId", err: errors.New(`ent: missing required field "HealthCare.farmId"`)}
	}
	if _, ok := hcc.mutation.FarmName(); !ok {
		return &ValidationError{Name: "farmName", err: errors.New(`ent: missing required field "HealthCare.farmName"`)}
	}
	if _, ok := hcc.mutation.ShedId(); !ok {
		return &ValidationError{Name: "shedId", err: errors.New(`ent: missing required field "HealthCare.shedId"`)}
	}
	if _, ok := hcc.mutation.ShedName(); !ok {
		return &ValidationError{Name: "shedName", err: errors.New(`ent: missing required field "HealthCare.shedName"`)}
	}
	if _, ok := hcc.mutation.EarNumber(); !ok {
		return &ValidationError{Name: "earNumber", err: errors.New(`ent: missing required field "HealthCare.earNumber"`)}
	}
	if _, ok := hcc.mutation.Date(); !ok {
		return &ValidationError{Name: "date", err: errors.New(`ent: missing required field "HealthCare.date"`)}
	}
	if _, ok := hcc.mutation.Reason(); !ok {
		return &ValidationError{Name: "reason", err: errors.New(`ent: missing required field "HealthCare.reason"`)}
	}
	if _, ok := hcc.mutation.Method(); !ok {
		return &ValidationError{Name: "method", err: errors.New(`ent: missing required field "HealthCare.method"`)}
	}
	if _, ok := hcc.mutation.VetName(); !ok {
		return &ValidationError{Name: "vetName", err: errors.New(`ent: missing required field "HealthCare.vetName"`)}
	}
	if _, ok := hcc.mutation.HoofArea(); !ok {
		return &ValidationError{Name: "hoofArea", err: errors.New(`ent: missing required field "HealthCare.hoofArea"`)}
	}
	if _, ok := hcc.mutation.HornMethod(); !ok {
		return &ValidationError{Name: "hornMethod", err: errors.New(`ent: missing required field "HealthCare.hornMethod"`)}
	}
	if _, ok := hcc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`ent: missing required field "HealthCare.createdAt"`)}
	}
	if _, ok := hcc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`ent: missing required field "HealthCare.updatedAt"`)}
	}
	if _, ok := hcc.mutation.Deleted(); !ok {
		return &ValidationError{Name: "deleted", err: errors.New(`ent: missing required field "HealthCare.deleted"`)}
	}
	if _, ok := hcc.mutation.Remarks(); !ok {
		return &ValidationError{Name: "remarks", err: errors.New(`ent: missing required field "HealthCare.remarks"`)}
	}
	return nil
}
...
// HealthCareCreateBulk is the builder for creating many HealthCare entities in bulk.
...
// Exec executes the query.
func (hccb *HealthCareCreateBulk) Exec(ctx context.Context) error {
	_, err := hccb.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (hccb *HealthCareCreateBulk) ExecX(ctx context.Context) {

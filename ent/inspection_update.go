...
// Where appends a list predicates to the InspectionUpdate builder.
...
// AddById adds i to the "byId" field.
...
// AddResultId adds i to the "resultId" field.
...
// AddHandleId adds i to the "handleId" field.
...
func (iuo *InspectionUpdateOne) Select(field string, fields ...string) *InspectionUpdateOne {
	iuo.fields = append([]string{field}, fields...)
	return iuo
}

// Save executes the query and returns the updated Inspection entity.
...
func (iuo *InspectionUpdateOne) sqlSave(ctx context.Context) (_node *Inspection, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "Inspection.id" for update`)}
	}

...
func (mq *MaterialQuery) FirstIDX(ctx context.Context) int {
...
func (mq *MaterialQuery) GroupBy(field string, fields ...string) *MaterialGroupBy {
	grbuild := &MaterialGroupBy{config: mq.config}
...
func (mq *MaterialQuery) Select(fields ...string) *MaterialSelect {
	...
	selbuild := &MaterialSelect{MaterialQuery: mq}
	selbuild.label = material.Label
...
func (ms *MaterialSelect) Scan(ctx context.Context, v interface{}) error {
	...
	ms.sql = ms.MaterialQuery.sqlQuery(ctx)

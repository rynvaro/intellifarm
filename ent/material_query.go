...
func (mq *MaterialQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (mq *MaterialQuery) FirstXID(ctx context.Context) int64 {
...
func (mq *MaterialQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (mq *MaterialQuery) OnlyIDX(ctx context.Context) int64 {
...
func (mq *MaterialQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (mq *MaterialQuery) IDsX(ctx context.Context) []int64 {
	ids, err := mq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (mq *MaterialQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if ps := mq.order; len(ps) > 0 {
		_spec.Order = func(selector *sql.Selector) {
			for i := range ps {
				ps[i](selector, material.ValidColumn)
			}
		}
	}
	return _spec
...
func (mq *MaterialQuery) sqlQuery() *sql.Selector {
	...
	for _, p := range mq.order {
		p(selector, material.ValidColumn)
	}
	if offset := mq.offset; offset != nil {
...
func (mgb *MaterialGroupBy) sqlQuery() *sql.Selector {
	...
	for _, fn := range mgb.fns {
		columns = append(columns, fn(selector, material.ValidColumn))
	}

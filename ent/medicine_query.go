...
func (mq *MedicineQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (mq *MedicineQuery) FirstXID(ctx context.Context) int64 {
...
func (mq *MedicineQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (mq *MedicineQuery) OnlyIDX(ctx context.Context) int64 {
...
func (mq *MedicineQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (mq *MedicineQuery) IDsX(ctx context.Context) []int64 {
	ids, err := mq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (mq *MedicineQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if ps := mq.order; len(ps) > 0 {
		_spec.Order = func(selector *sql.Selector) {
			for i := range ps {
				ps[i](selector, medicine.ValidColumn)
			}
		}
	}
	return _spec
...
func (mq *MedicineQuery) sqlQuery() *sql.Selector {
	...
	for _, p := range mq.order {
		p(selector, medicine.ValidColumn)
	}
	if offset := mq.offset; offset != nil {
...
func (mgb *MedicineGroupBy) sqlQuery() *sql.Selector {
	...
	for _, fn := range mgb.fns {
		columns = append(columns, fn(selector, medicine.ValidColumn))
	}

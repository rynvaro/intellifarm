...
var (
	...
	BirthSurroundingsColumns = []*schema.Column{
		...
		{Name: "rained", Type: field.TypeInt, Default: 0},
	...
	CattlesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "alive", Type: field.TypeInt, Default: 1},
		{Name: "health", Type: field.TypeInt, Default: 1},
	...
	CattleDiesColumns = []*schema.Column{
		...
		{Name: "user_name", Type: field.TypeString},
		{Name: "reason_id", Type: field.TypeInt},
		{Name: "reason_name", Type: field.TypeString},
		...
		{Name: "handle_method", Type: field.TypeString},
	...
	CattleMovesColumns = []*schema.Column{
		...
		{Name: "ear_number", Type: field.TypeString},
		{Name: "date", Type: field.TypeInt64},
		{Name: "from_shed_id", Type: field.TypeInt64},
		{Name: "from_shed", Type: field.TypeString},
		{Name: "to_shed_id", Type: field.TypeInt64},
		{Name: "to_shed", Type: field.TypeString},
		{Name: "user_name", Type: field.TypeString},
		{Name: "reason_id", Type: field.TypeInt64},
		{Name: "reason_name", Type: field.TypeString},
		{Name: "remarks", Type: field.TypeString},
		{Name: "created_at", Type: field.TypeInt64},
		{Name: "updated_at", Type: field.TypeInt64},
	...
	// ConcentratesColumns holds the columns for the "concentrates" table.
	ConcentratesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "name", Type: field.TypeString},
		{Name: "formula_id", Type: field.TypeInt64},
		{Name: "formula_name", Type: field.TypeString},
		{Name: "formula_code", Type: field.TypeString},
	...
	// ConcentratesTable holds the schema information for the "concentrates" table.
	ConcentratesTable = &schema.Table{
		Name:       "concentrates",
		Columns:    ConcentratesColumns,
		PrimaryKey: []*schema.Column{ConcentratesColumns[0]},
	}
	...
	ConcentrateProcessesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "concentrate_id", Type: field.TypeInt64},
		{Name: "name", Type: field.TypeString, Nullable: true},
		{Name: "date", Type: field.TypeInt64},
	...
	DiseaseInfosColumns = []*schema.Column{
		...
		{Name: "deleted", Type: field.TypeInt, Nullable: true},
	}
	...
	EventsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "ear_number", Type: field.TypeString},
		{Name: "event_type_id", Type: field.TypeInt, Nullable: true},
		{Name: "event_type_name", Type: field.TypeString},
		{Name: "event_sub_type_id", Type: field.TypeInt, Nullable: true},
		{Name: "event_sub_type_name", Type: field.TypeString},
		{Name: "tenant_id", Type: field.TypeInt64},
		{Name: "tenant_name", Type: field.TypeString},
		{Name: "farm_id", Type: field.TypeInt64},
		{Name: "farm_name", Type: field.TypeString},
		{Name: "shed_id", Type: field.TypeInt64, Nullable: true},
		{Name: "shed_name", Type: field.TypeString, Nullable: true},
		{Name: "times", Type: field.TypeInt, Nullable: true, Default: -1},
		{Name: "created_at", Type: field.TypeInt64},
		{Name: "deleted", Type: field.TypeInt},
	}
	...
	FeedInfosColumns = []*schema.Column{
		...
		{Name: "name", Type: field.TypeString},
		{Name: "code", Type: field.TypeString},
		{Name: "moisture", Type: field.TypeFloat32},
		{Name: "dry_matter", Type: field.TypeFloat32},
		{Name: "ndf", Type: field.TypeFloat32},
		{Name: "adf", Type: field.TypeFloat32},
		{Name: "endf", Type: field.TypeFloat32},
		{Name: "lactic_acid", Type: field.TypeFloat32},
		{Name: "wsc", Type: field.TypeFloat32},
		{Name: "starch", Type: field.TypeFloat32},
		{Name: "soluble_fiber", Type: field.TypeFloat32},
		{Name: "total_protein", Type: field.TypeFloat32},
		{Name: "soluble_protein", Type: field.TypeFloat32},
		{Name: "rdp", Type: field.TypeFloat32},
		{Name: "me", Type: field.TypeFloat32},
		{Name: "nel", Type: field.TypeFloat32},
		{Name: "crude_fat", Type: field.TypeFloat32},
		{Name: "total_ftty_acid", Type: field.TypeFloat32},
		{Name: "ash", Type: field.TypeFloat32},
		{Name: "ca", Type: field.TypeFloat32},
		{Name: "p", Type: field.TypeFloat32},
		{Name: "mg", Type: field.TypeFloat32},
		{Name: "k", Type: field.TypeFloat32},
		{Name: "mn", Type: field.TypeFloat32},
		{Name: "cu", Type: field.TypeFloat32},
		{Name: "fe", Type: field.TypeFloat32},
		{Name: "zn", Type: field.TypeFloat32},
		{Name: "methionine", Type: field.TypeFloat32},
		{Name: "lysine", Type: field.TypeFloat32},
		{Name: "vitamina", Type: field.TypeFloat32},
		{Name: "vitamin_d3", Type: field.TypeFloat32},
		{Name: "vitamine", Type: field.TypeFloat32},
		{Name: "choline", Type: field.TypeFloat32},
		{Name: "biotin", Type: field.TypeFloat32},
		{Name: "description", Type: field.TypeString, Nullable: true},
		{Name: "tenant_id", Type: field.TypeInt64, Nullable: true},
		{Name: "tenant_name", Type: field.TypeString, Nullable: true},
		...
		{Name: "remarks", Type: field.TypeString, Nullable: true},
		{Name: "created_at", Type: field.TypeInt64, Nullable: true, Default: 1662386628},
		{Name: "updated_at", Type: field.TypeInt64, Nullable: true, Default: 1662386628},
	...
	InventoryFlowsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "sys_material_id", Type: field.TypeInt64},
		...
		{Name: "before", Type: field.TypeInt64},
		{Name: "after", Type: field.TypeInt64},
		{Name: "user_name", Type: field.TypeString},
		{Name: "tenant_id", Type: field.TypeInt64},
		{Name: "tenant_name", Type: field.TypeString},
		{Name: "farm_id", Type: field.TypeInt64},
		{Name: "farm_name", Type: field.TypeString},
		{Name: "remarks", Type: field.TypeString},
		{Name: "is_checked", Type: field.TypeBool},
		{Name: "report_file_address", Type: field.TypeString},
		{Name: "created_at", Type: field.TypeInt64},
		{Name: "updated_at", Type: field.TypeInt64},
		{Name: "deleted", Type: field.TypeInt},
	}
	...
	MaterialsColumns = []*schema.Column{
		...
		{Name: "category_name", Type: field.TypeString},
		{Name: "user_name", Type: field.TypeString},
		{Name: "inventory", Type: field.TypeInt64, Default: 0},
		{Name: "tenant_id", Type: field.TypeInt64},
		{Name: "tenant_name", Type: field.TypeString},
		{Name: "farm_id", Type: field.TypeInt64},
		{Name: "farm_name", Type: field.TypeString},
	...
	// RationFormulasColumns holds the columns for the "ration_formulas" table.
	RationFormulasColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "name", Type: field.TypeString},
		{Name: "code", Type: field.TypeString},
		{Name: "status", Type: field.TypeInt},
	...
	// RationFormulasTable holds the schema information for the "ration_formulas" table.
	RationFormulasTable = &schema.Table{
		Name:       "ration_formulas",
		Columns:    RationFormulasColumns,
		PrimaryKey: []*schema.Column{RationFormulasColumns[0]},
	}
	// RationProcessesColumns holds the columns for the "ration_processes" table.
	RationProcessesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "ration_id", Type: field.TypeInt64},
		{Name: "name", Type: field.TypeString, Nullable: true},
		{Name: "date", Type: field.TypeInt64},
		{Name: "count", Type: field.TypeInt64},
		{Name: "in", Type: field.TypeInt64},
	...
	// RationProcessesTable holds the schema information for the "ration_processes" table.
	RationProcessesTable = &schema.Table{
		Name:       "ration_processes",
		Columns:    RationProcessesColumns,
		PrimaryKey: []*schema.Column{RationProcessesColumns[0]},
	}

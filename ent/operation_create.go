...
func (oc *OperationCreate) check() error {
	if _, ok := oc.mutation.UserId(); !ok {
		return &ValidationError{Name: "userId", err: errors.New(`ent: missing required field "Operation.userId"`)}
	}
	if _, ok := oc.mutation.UserName(); !ok {
		return &ValidationError{Name: "userName", err: errors.New(`ent: missing required field "Operation.userName"`)}
	}
	if _, ok := oc.mutation.TenantId(); !ok {
		return &ValidationError{Name: "tenantId", err: errors.New(`ent: missing required field "Operation.tenantId"`)}
	}
	if _, ok := oc.mutation.TenantName(); !ok {
		return &ValidationError{Name: "tenantName", err: errors.New(`ent: missing required field "Operation.tenantName"`)}
	}
	if _, ok := oc.mutation.FarmId(); !ok {
		return &ValidationError{Name: "farmId", err: errors.New(`ent: missing required field "Operation.farmId"`)}
	}
	if _, ok := oc.mutation.FarmName(); !ok {
		return &ValidationError{Name: "farmName", err: errors.New(`ent: missing required field "Operation.farmName"`)}
	}
	if _, ok := oc.mutation.API(); !ok {
		return &ValidationError{Name: "api", err: errors.New(`ent: missing required field "Operation.api"`)}
	}
	if _, ok := oc.mutation.IP(); !ok {
		return &ValidationError{Name: "ip", err: errors.New(`ent: missing required field "Operation.ip"`)}
	}
	if _, ok := oc.mutation.Method(); !ok {
		return &ValidationError{Name: "method", err: errors.New(`ent: missing required field "Operation.method"`)}
	}
	if _, ok := oc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`ent: missing required field "Operation.createdAt"`)}
	}
	if _, ok := oc.mutation.Deleted(); !ok {
		return &ValidationError{Name: "deleted", err: errors.New(`ent: missing required field "Operation.deleted"`)}
	}
	return nil
}

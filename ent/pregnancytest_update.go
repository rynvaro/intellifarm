...
// Where appends a list predicates to the PregnancyTestUpdate builder.
...
// AddTestAt adds i to the "testAt" field.
...
// AddPregnancyTestTypeId adds i to the "pregnancyTestTypeId" field.
...
// AddPregnancyTestMethodId adds i to the "pregnancyTestMethodId" field.
...
// AddPregnancyTestResultId adds i to the "pregnancyTestResultId" field.
...
func (ptuo *PregnancyTestUpdateOne) Select(field string, fields ...string) *PregnancyTestUpdateOne {
	ptuo.fields = append([]string{field}, fields...)
	return ptuo
}

// Save executes the query and returns the updated PregnancyTest entity.
...
func (ptuo *PregnancyTestUpdateOne) sqlSave(ctx context.Context) (_node *PregnancyTest, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "PregnancyTest.id" for update`)}
	}

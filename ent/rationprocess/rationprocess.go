...
const (
	// Label holds the string label denoting the rationprocess type in the database.
	Label = "ration_process"
	// FieldID holds the string denoting the id field in the database.
	FieldID = "id"
	// FieldRationId holds the string denoting the rationid field in the database.
	FieldRationId = "ration_id"
	...
	// Table holds the table name of the rationprocess in the database.
	Table = "ration_processes"
)

// Columns holds all SQL columns for rationprocess fields.
var Columns = []string{
	FieldID,
	FieldRationId,
	FieldName,

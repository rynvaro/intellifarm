...
func ID(id int64) predicate.Shed {
...
func IDEQ(id int64) predicate.Shed {
	return predicate.Shed(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int64) predicate.Shed {
	return predicate.Shed(func(s *sql.Selector) {
...
func IDIn(ids ...int64) predicate.Shed {
	return predicate.Shed(func(s *sql.Selector) {
...
func IDNotIn(ids ...int64) predicate.Shed {
	return predicate.Shed(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int64) predicate.Shed {
	return predicate.Shed(func(s *sql.Selector) {
...
func IDGTE(id int64) predicate.Shed {
	return predicate.Shed(func(s *sql.Selector) {
...
func IDLT(id int64) predicate.Shed {
	return predicate.Shed(func(s *sql.Selector) {
...
func IDLTE(id int64) predicate.Shed {
	return predicate.Shed(func(s *sql.Selector) {
